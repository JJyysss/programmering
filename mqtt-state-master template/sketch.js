...
// variabel der bestemmer hvilken farve der vises/skal trkkes på knap
let currentColor = 0
function setup() {
...
// rekursiv fuktion er kalder sig selv
function showColors( position ){
  ...
  if ( position < colors.length -1){
    // timeout tage to argument, hvornår skal gøre efter
